                ...
                <div class="container">
                  ...
                  <c:if test="${not empty pudins}">
                    <div class="alert alert-info">
                      <strong>Sucesso!</strong> ${mensagem} Quantidade de pudins cadastrados:
                      ${pudins.size()}.
                    </div>
                  </c:if>
                      ...
                      <tbody>
                        <c:forEach var="p" items="${pudins}">
                          <tr class="table-info">
                            ...
                            <td>${p.lactose}</td>
                            <td>${p.quantidade}</td>
                            <td>$${p.calcularValorPorKilo()}</td>
                            <td>
                              <form action="/pudim/${p.id}/excluir" method="get">
