              ...
              <div class="cta-inner bg-faded text-center rounded">
                ...
                <form action="/torta/incluir" method="post">
                  <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                    ...
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="text" minlength="6" maxlength="6" class="form-control"
                          placeholder="Entre o código da torta" name="codigo" value="AABAAB">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="text" minlength="1" maxlength="20" class="form-control"
                          placeholder="Entre o nome da torta" name="nome" value="Torta de Limão">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        <label>Sabor:</label>
                        <input required type="text" minlength="1" maxlength="20" class="form-control"
                          placeholder="Entre o sabor da torta" name="sabor" value="Limão">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="number" min="1" max="999" class="form-control"
                          placeholder="Entre o kilo da torta" name="kilo" value="1">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="number" min="1" max="999" step="any" class="form-control"
                          placeholder="Entre o valor por kilo da torta" name="valorKg" value="20">
                      </div>
                    </li>
                    ...
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        <label class="form-check-label center" for="doce">
                          Doce:
                        </label>
                        <input class="form-check-input" type="radio" name="isDoce" id="doce" value="True" checked>
                      </div>
                      <div class="form-group">
                        <label class="form-check-label center" for="salgada">
                          Salgada:
                        </label>
                    ...
                    <li class="list-unstyled-item list-underline">
                      <div class="form-group">
                        <label class="form-check-label center" for="vegana">Vegana:</label>
                        <input class="form-check-input" type="checkbox" id="vegana" name="vegana">
                      </div>
                    </li>
                    ...
                    <li class="list-unstyled-item list-underline">
                      <div class="form-group">
                        ...
                        <input required type="text" minlength="1" maxlength="20" class="form-control"
                          placeholder="Entre a descrição da decoração" name="decoracao" value="Cobertura de Limão">
                      </div>
                    </li>
                  </ul>
