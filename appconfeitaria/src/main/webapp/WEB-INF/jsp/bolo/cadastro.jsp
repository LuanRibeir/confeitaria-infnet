            ...
            <div class="col-xl-9 mx-auto">
              <div class="cta-inner bg-faded text-center rounded">
                ...
                <h2 class="section-heading mb-5">
                  <span class="section-heading-lower">Cadastro de Tortas</span>
                </h2>
                  ...
                  <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                    ...
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="text" minlength="6" maxlength="6" class="form-control"
                          placeholder="Entre o código do bolo" name="codigo" value="AABAAB">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="text" minlength="1" maxlength="20" class="form-control"
                          placeholder="Entre o nome do bolo" name="nome" value="Bolo de Limão">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        <label>Sabor:</label>
                        <input required type="text" minlength="1" maxlength="20" class="form-control"
                          placeholder="Entre o sabor do bolo" name="sabor" value="Limão">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="number" min="1" max="999" class="form-control"
                          placeholder="Entre o kilo do bolo" name="kilo" value="1">
                      </div>
                    </li>
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="number" min="1" max="999" step="any" class="form-control"
                          placeholder="Entre o valor por kilo do bolo" name="valorKg" value="20">
                      </div>
                    </li>
                    ...
                    <li class="list-unstyled-item list-underline">
                      <div class="form-group">
                        ...
                        <input required type="text" minlength="1" maxlength="20" class="form-control"
                          placeholder="Entre o sabor da cobertura" name="saborCobertura" value="Chocolate">
                      </div>
                    </li>
                    ...
                    <li class="list-unstyled-item list-underline center">
                      <label>Formato:</label>
                      <div class="form-group">
                        <label class="form-check-label center" for="redondo">
                          Redondo:
                        </label>
                        <input class="form-check-input" type="radio" name="formato" id="redondo" value="redondo"
                          checked>
                      </div>
                      <div class="form-group">
                        <label class="form-check-label center" for="quadrado">
                          Quadrado:
                        </label>
                        <input class="form-check-input" type="radio" name="formato" id="quadrado" value="quadrado">
                      </div>
                    </li>
                    ...
                    <li class="list-unstyled-item list-underline center">
                      <div class="form-group">
                        ...
                        <input required type="number" min="1" max="999" class="form-control"
                          placeholder="Entre o número de camadas" name="camadas" value="2">
                      </div>
                    </li>
                  </ul>
